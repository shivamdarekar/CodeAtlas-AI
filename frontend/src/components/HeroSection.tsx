  ...
  return (
    <div className="w-full bg-[#050505] min-h-screen relative pt-[98px] pb-0">
      ...
      >
        ...
        <div className="absolute inset-0 z-[10] pointer-events-none bg-gradient-to-b from-[#0a0a0a]/60 via-[#0a0a0a]/80 to-[#0a0a0a]" />

        {/* Layer 1.5: Radial glow behind text to improve readability */}
        <div className="absolute top-[10%] left-1/2 -translate-x-1/2 w-[600px] h-[400px] bg-black/60 blur-[100px] rounded-full pointer-events-none z-[15]" />
        ...
        <div className="relative z-20 flex flex-col items-center justify-start text-center px-4 pt-[140px]">
          ...
          >
            ...
            <motion.div variants={reduce ? undefined : item} className="mb-6 inline-block">
              <div className="flex items-center gap-2 px-3 py-1.5 rounded-full border border-[#98b090]/40 bg-[#98b090]/20 backdrop-blur-md">
            ...
            <motion.h1
              ...
              className="font-[family-name:var(--font-instrument)] text-[64px] text-white mb-[32px] leading-[1.05] tracking-[-0.02em] max-w-[800px] font-normal drop-shadow-[0_4px_32px_rgba(0,0,0,1)]"
            >
            ...
            <motion.p
              variants={reduce ? undefined : item}
              className="font-[family-name:var(--font-inter)] text-lg md:text-xl text-white/90 max-w-[65ch] mb-[40px] leading-relaxed drop-shadow-[0_2px_16px_rgba(0,0,0,1)]"
            >
